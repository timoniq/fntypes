...
print(u.detach().unwrap()) # Variative[Dog, Animal](instance of Cat) (Variative contains Cat, if we detach Cat from it its ok! because Cat is still an Animal which is not detachd)
